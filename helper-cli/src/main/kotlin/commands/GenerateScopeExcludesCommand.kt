...
@Parameters(
    ...
    commandDescription = "Generate scope excludes."
)
internal class GenerateScopeExcludesCommand : CommandWithHelp() {
    ...
    override fun runCommand(jc: JCommander): Int {
        ...
        println(yamlMapper.writeValueAsString(scopeExcludes))
...
private fun OrtResult.generateScopeExcludes(): List<ScopeExclude> {
    ...
    }.associate { scopeExclude ->
        scopeExclude to projectScopes.filter { scopeExclude.matches(it) }.toSet()
    }
