...
object SpdxLicenseAliasMapping {
    ...
    private val customNames = mapOf(
        ...
        "apache_2_0" to APACHE_2_0,
        "apache_v2" to APACHE_2_0,
        "artistic_1" to ARTISTIC_1_0,
        "artistic_2" to ARTISTIC_2_0,
        "asl" to APACHE_2_0,
        "BOOST" to BSL_1_0,
        "boost" to BSL_1_0,
        "Bouncy" to MIT,
        ...
        "lgpl" to LGPL_2_1_ONLY,
        "lgpl_2_1" to LGPL_2_1_ONLY,
        "lgpl_v2_1" to LGPL_2_1_ONLY,
        "lgpl_v3" to LGPL_3_0_ONLY,
        "lgpl2" to LGPL_2_1_ONLY,
        "lgpl3" to LGPL_3_0_ONLY,
        "lgplv2" to LGPL_2_0_ONLY,
        "lgplv3" to LGPL_3_0_ONLY,
        "MIT-like" to MIT,
        "MIT-style" to MIT,
        "mit-license" to MIT,
