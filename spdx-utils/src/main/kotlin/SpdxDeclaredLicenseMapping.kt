...
object SpdxDeclaredLicenseMapping {
    ...
    val mapping = mapOf(
        ...
        "Academy of Motion Picture Arts and Sciences BSD" to AMPAS.toExpression(),
        ...
        "Abstyles License" to ABSTYLES.toExpression(),
        "Academic Free License (AFL)" to AFL_2_1.toExpression(),
        "Academic Free License (AFL-2.1)" to AFL_2_1.toExpression(),
        "Academic Free License v1.1" to AFL_1_1.toExpression(),
        "Academic Free License v1.2" to AFL_1_2.toExpression(),
        "Academic Free License v2.0" to AFL_2_0.toExpression(),
        "Academic Free License v2.1" to AFL_2_1.toExpression(),
        "Academic Free License v3.0" to AFL_3_0.toExpression(),
        "Adaptive Public License 1.0" to APL_1.0.toExpression(),
        "Adobe Glyph List License" to ADOBE_GLYPH.toExpression(),
        "Adobe Postscript AFM License" to APAFML.toExpression(),
        "Adobe Systems Incorporated Source Code License Agreement" to ADOBE_2006.toExpression(),
        "Affero General Public License v1.0 only" to AGPL_1_0_ONLY.toExpression(),
        "Affero General Public License v1.0 or later" to AGPL_1_0_OR_LATER.toExpression(),
        "Afmparse License" to AFMPARSE.toExpression(),
        "AGPL v3+" to AGPL_3_0_OR_LATER.toExpression(),
        "Aladdin Free Public License" to AFPL.toExpression(),
        "Aladdin Free Public License (AFPL)" to AFPL.toExpression(),
        "AMD's plpa_map.c License" to AMDPLPA.toExpression(),
        "Amazon Digital Services License" to ADSL.toExpression(),
        "ANTLR Software Rights Notice" to ANTLR_PD.toExpression(),
        ...
        "Apache License 1.0" to APACHE_1_0.toExpression(),
        "Apache License 1.1" to APACHE_1_1.toExpression(),
 ...
 """.trimIndent() to APACHE_2_0.toExpression(),
        "Apple MIT License" to AMT.toExpression(),
        "Apple Public Source License" to APSL_1_0.toExpression(),
        "Apple Public Source License 1.0" to APSL_1_0.toExpression(),
        "Apple Public Source License 1.1" to APSL_1_1.toExpression(),
        "Apple Public Source License 1.2" to APSL_1_2.toExpression(),
        "Apple Public Source License 2.0" to APSL_2_0.toExpression(),
        "Artistic License" to ARTISTIC_2_0.toExpression(),
        "academic free license (afl)" to AFL_3_0.toExpression(),
        "asl 2.0" to APACHE_2_0.toExpression(),
        "Attribution Assurance License" to licenseRef("attribution", "scancode"),
        "Artistic 2.0" to ARTISTIC_2_0.toExpression(),
        "Artistic License 1.0" to ARTISTIC_1_0.toExpression(),
        "Artistic License 1.0 w/clause 8" to ARTISTIC_1_0_CL8.toExpression(),
        "Artistic License 1.0 (Perl)" to ARTISTIC_1_0_PERL.toExpression(),
        "Artistic License 2.0" to ARTISTIC_1_0.toExpression(),
        "artistic license v2.0" to ARTISTIC_2_0.toExpression(),
        "Bahyph License" to BAHYPH.toExpression(),
        "Barr License" to BARR.toExpression(),
        "Beerware License" to BEERWARE.toExpression(),
        "BitTorrent Open Source License v1.0" to BITTORRENT_1_0.toExpression(),
        "BitTorrent Open Source License v1.1" to BITTORRENT_1_1.toExpression(),
        "Blue Oak Model License 1.0.0" to BLUEOAK_1_0_0.toExpression(),
        "Borceux license" to BORCEUX.toExpression(),
        ...
        "Boost Software License 1.0" to BSL_1_0.toExpression(),
        ...
        "BSD 1-Clause License" to BSD_1_CLAUSE.toExpression(),
        ...
        "BSD 2-Clause \"Simplified\" License" to BSD_2_CLAUSE.toExpression(),
        ...
        """BSD 2-clause &quot;Simplified&quot; or &quot;FreeBSD&quot;
                License
         """.trimIndent() to (BSD_2_CLAUSE or BSD_2_CLAUSE_FREEBSD),
        "BSD 2-Clause FreeBSD License" to BSD_2_CLAUSE_FREEBSD.toExpression(),
        "BSD 2-Clause NetBSD License" to BSD_2_CLAUSE_NETBSD.toExpression(),
        "BSD-2-Clause Plus Patent License" to BSD_2_CLAUSE_PATENT.toExpression(),
        "BSD 3" to BSD_3_CLAUSE.toExpression(),
        "BSD 3 Clause" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause \"New\" or \"Revised\" License" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause \"New\" or \"Revised\" License (BSD-3-Clause)" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause Clear License" to BSD_3_CLAUSE_CLEAR.toExpression(),
        "BSD 3-Clause License" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause license" to BSD_3_CLAUSE.toExpression(),
        "BSD 3-Clause No Nuclear License" to BSD_3_CLAUSE_NO_NUCLEAR_LICENSE.toExpression(),
        "BSD 3-Clause No Nuclear License 2014" to BSD_3_CLAUSE_NO_NUCLEAR_LICENSE_2014.toExpression(),
        "BSD 3-Clause No Nuclear Warranty" to BSD_3_CLAUSE_NO_NUCLEAR_WARRANTY.toExpression(),
        "BSD 3-Clause Open MPI variant" to BSD_3_CLAUSE_OPEN_MPI.toExpression(),
        "BSD 3-clause" to BSD_3_CLAUSE.toExpression(),
        "BSD 4 Clause" to BSD_4_CLAUSE.toExpression(),
        "BSD 4-Clause \"Original\" or \"Old\" License" to BSD_4_CLAUSE.toExpression(),
        "BSD-4-Clause (University of California-Specific)" to BSD_4_CLAUSE_UC.toExpression(),
        ...
        "BSD Protection License" to BSD_PROTECTION.toExpression(),
        "BSD Source Code Attribution" to BSD_SOURCE_CODE.toExpression(),
        ...
        "BSD Zero Clause License" to _0BSD.toExpression(),
        ...
        "BSD with attribution" to BSD_3_CLAUSE_ATTRIBUTION.toExpression(),
        "BSD-like" to BSD_3_CLAUSE.toExpression(),
        ...
        "Caldera License" to CALDERA.toExpression(),
        ...
        "CeCILL 2.1" to CECILL_2_1.toExpression(),
        "CeCILL Free Software License Agreement v1.0" to CECILL_1_0.toExpression(),
        "CeCILL Free Software License Agreement v1.1" to CECILL_1_1.toExpression(),
        "CeCILL Free Software License Agreement v2.0" to CECILL_2_0.toExpression(),
        "CeCILL Free Software License Agreement v2.1" to CECILL_2_1.toExpression(),
        "CeCILL-B licence" to CECILL_B.toExpression(),
        "CeCILL-B Free Software License Agreement" to CECILL_B.toExpression(),
        "CeCILL-B Free Software License Agreement (CECILL-B)" to CECILL_B.toExpression(),
        "CeCILL-C Free Software License Agreement" to CECILL_C.toExpression(),
        ...
        "CERN Open Hardware License v1.1" to CERN_OHL_1_1.toExpression(),
        "CERN Open Hardware License v1.2" to CERN_OHL_1_2.toExpression(),
        "Clarified Artistic License" to CLARTISTIC.toExpression(),
        ...
        "Common Development and Distribution License 1.0" to CDDL_1_0.toExpression(),
        "Common Development and Distribution License 1.0 (CDDL-1.0)" to CDDL_1_0.toExpression(),
        "Common Development and Distribution License 1.1" to CDDL_1_1.toExpression(),
        ...
        "Community Data License Agreement Permissive 1.0" to  CDLA_PERMISSIVE_1_0.toExpression(),
        "Community Data License Agreement Sharing 1.0" to CDLA_SHARING_1_0.toExpression(),
        "Computer Associates Trusted Open Source License 1.1" to CATOSL_1_1.toExpression(),
        "CNRI Jython License" to CNRI_JYTHON.toExpression(),
        "CNRI Python License" to CNRI_PYTHON.toExpression(),
        "CNRI Python Open Source GPL Compatible License Agreement" to CNRI_PYTHON_GPL_COMPATIBLE.toExpression(),
        "Condor Public License v1.1" to CONDOR_1_1.toExpression(),
        "copyleft-next 0.3.0" to COPYLEFT_NEXT_0_3_0.toExpression(),
        "copyleft-next 0.3.1" to COPYLEFT_NEXT_0_3_1.toExpression(),
        "Common Public Attribution License 1.0" to CPAL_1_0.toExpression(),
        "Common Public License 1.0" to CPL_1_0.toExpression(),
        "Code Project Open License 1.02" to CPOL_1_02.toExpression(),
        "Crossword License" to CROSSWORD.toExpression(),
        "CrystalStacker License" to CRYSTALSTACKER.toExpression(),
        "CUA Office Public License v1.0" CUA_OPL_1_0.toExpression(),
        "Cube License" to CUBE.toExpression(),
        "curl License" to CURL.toExpression(),
        ...
        "Creative Commons Attribution 1.0 Generic" to CC_BY_1_0.toExpression(),
        "Creative Commons Attribution 2.0 Generic" to CC_BY_2_0.toExpression(),
        "Creative Commons Attribution 2.5" to CC_BY_2_5.toExpression(),
        "Creative Commons Attribution 2.5 Generic" to CC_BY_2_5.toExpression(),
        ...
        "Creative Commons Attribution 3.0 Unported" to CC_BY_3_0.toExpression(),
        ...
        "Creative Commons Attribution 4.0 International" to CC_BY_4_0.toExpression(),
        "Creative Commons Attribution 4.0 International (CC BY 4.0)".toExpression(),
        "Creative Commons Attribution 4.0 International Public License".toExpression(),
        "Creative Commons Attribution License" to CC_BY_3_0.toExpression(),
        "Creative Commons Attribution Non Commercial 1.0 Generic" to CC_BY_NC_1_0.toExpression(),
        "Creative Commons Attribution Non Commercial 2.0 Generic" to CC_BY_NC_2_0.toExpression(),
        "Creative Commons Attribution Non Commercial 2.5 Generic" to CC_BY_NC_2_5.toExpression(),
        "Creative Commons Attribution Non Commercial 3.0 Unported" to CC_BY_NC_3_0.toExpression(),
        "Creative Commons Attribution Non Commercial 4.0 International" to CC_BY_NC_4_0.toExpression(),
        "Creative Commons Attribution Non Commercial No Derivatives 1.0 Generic" to CC_BY_NC_ND_1_0.toExpression(),
        "Creative Commons Attribution Non Commercial No Derivatives 2.0 Generic" to CC_BY_NC_ND_2_0.toExpression(),
        "Creative Commons Attribution Non Commercial No Derivatives 2.5 Generic" to CC_BY_NC_ND_2_5.toExpression(),
        "Creative Commons Attribution Non Commercial No Derivatives 3.0 Unported" to CC_BY_NC_ND_3_0.toExpression(),
        "Creative Commons Attribution Non Commercial No Derivatives 4.0 International" to CC_BY_NC_ND_4_0.toExpression(),
        "Creative Commons Attribution Non Commercial Share Alike 1.0 Generic" to CC_BY_NC_SA_1_0.toExpression(),
        "Creative Commons Attribution Non Commercial Share Alike 2.0 Generic" to CC_BY_NC_SA_2_0.toExpression(),
        "Creative Commons Attribution Non Commercial Share Alike 2.5 Generic" to CC_BY_NC_SA_2_5.toExpression(),
        "Creative Commons Attribution Non Commercial Share Alike 3.0 Unported" to CC_BY_NC_SA_3_0.toExpression(),
        "Creative Commons Attribution Non Commercial Share Alike 4.0 International" to CC_BY_NC_SA_4_0.toExpression(),
        "Creative Commons Attribution No Derivatives 1.0 Generic" to CC_BY_ND_1_0.toExpression(),
        "Creative Commons Attribution No Derivatives 2.0 Generic" to CC_BY_ND_2_0.toExpression(),
        "Creative Commons Attribution No Derivatives 2.5 Generic" to CC_BY_ND_2_5.toExpression(),
        "Creative Commons Attribution No Derivatives 3.0 Unported" to CC_BY_ND_3_0.toExpression(),
        "Creative Commons Attribution No Derivatives 4.0 International" to CC_BY_ND_4_0.toExpression(),
        "Creative Commons Attribution Share Alike 1.0 Generic" to CC_BY_SA_1_0.toExpression(),
        "Creative Commons Attribution Share Alike 2.0 Generic" to CC_BY_SA_2_0.toExpression(),
        "Creative Commons Attribution Share Alike 2.5 Generic" to CC_BY_SA_2_5.toExpression(),
        "Creative Commons Attribution Share Alike 3.0 Unported" to CC_BY_SA_3_0.toExpression(),
        "Creative Commons Attribution Share Alike 4.0 International" to CC_BY_SA_4_0".toExpression(),
        ...
        "Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported (CC BY-NC-SA 3.0)" to CC_BY_NC_SA_3_0.toExpression(),
        ...
        "Creative Commons Public Domain Dedication and Certification" to CC_PDDC.toExpression(),
        "Creative Commons Zero" to CC0_1_0.toExpression(),
        "Creative Commons Zero v1.0 Universal" to CC0_1_0.toExpression(),
        ...
        "Eiffel Forum License v1.0" to EFL_1_0.toExpression(),
        "Eiffel Forum License v2.0" to EFL_2_0.toExpression(),
        ...
        "European Union Public Licence 1.2" to EUPL_2_0.toExpression(),
        "European Union Public Licence 1.2 (EUPL 1.2)" to EUPL_2_0.toExpression(),
        "European Union Public License v. 1.2" to EUPL_2_0.toExpression(),
        "eupl 1.0" to EUPL_1_0.toExpression(),
        "eupl 2.0" to EUPL_2_0.toExpression(),
        "eupl v1.0" to EUL_1_0.toExpression(),
        "eupl v2.0" to EUPL_2_0.toExpression(),
        "eu public licence 1.0 (eupl 1.0)" to EUPL-1.0.toExpression(),
        "eu public licence 1.1 (eupl 1.1)" to EUPL-1.1.toExpression(),
        "eu public licence 1.2 (eupl 1.2)" to EUPL-1.2.toExpression(),
        "european union public licence 1.0 (eupl 1.0)" to EUPL-1.0.toExpression(),
        "european union public licence 1.1 (eupl 1.1)" to EUPL-1.1.toExpression(),
        "european union public licence 1.2 (eupl 1.2)" to EUPL-1.2.toExpression(),
        "GNU Affero General Public License v3.0 only" to AGPL_3_0_ONLY.toExpression(),
        "GNU Affero General Public License v3.0 or later" to AGPL_3_0_OR_LATER.toExpression(),
        ...
        "GNU Affero General Public License, Version 3 with the Commons Clause" to (AGPL_3_0_ONLY AND licenseRef("public-domain-disclaimer", "scancode")),
        ...
        "GNU General Public Library" to GPL_2_0_ONLY.toExpression(),
        "GNU General Public License (GPL)" to GPL_2_0_ONLY.toExpression(),
        ...
        "GNU Lesser General Public License v2 (LGPLv2)" to LGPL_2_1_ONLY.toExpression(),
        ...
        "gpl2 w/ cpe" to GPL_2_0_WITH_CLASSPATH_EXCEPTION.toExpression(),
        "gnu lgpl v3+" to LGPL_3_0_OR_LATER.toExpression(),
        "gnu general public license (gpl)" to GPL_2_0_ONLY.toExpression(),
        "gnu general public license v2 (gplv2)" to GPL_2_0_ONLY.toExpression(),
        "gnu general public license v2 or later (gplv2+)" to GPL_2_0_OR_LATER.toExpression(),
        ...
        "gnu lesser general public license" to LGPL_2_0_ONLY.toExpression(),
        "gnu lesser general public license v2 (lgplv2)" to LGPL_2_0_ONLY.toExpression(),
        "gnu lesser general public license v2 or later (lgplv2+)" to LGPL_2_0_OR_LATER.toExpression(),
        "gnu lesser general public license v3 (lgplv3)" to LGPL_3_0_ONLY.toExpression(),
        "gnu lesser general public license v3 or later (lgplv3+)" to LGPL_3_0_OR_LATER.toExpression(),
        "gnu library or lesser general public license (lgpl)" to LGPL_2_0_ONLY.toExpression(),
        "HSQLDB License" to BSD_3_CLAUSE.toExpression(),
        "HSQLDB License, a BSD open source license" to BSD_3_CLAUSE.toExpression(),
        "Historical Permission Notice and Disclaimer" to HPND.toExpression(),
        ...
        "Intel Open Source License" to INTEL.toExpression(),
        ...
        "Lawrence Berkeley National Labs BSD variant license" to BSD-3-Clause-LBNL.toExpression(),
        ...
        "Motosoto License" to MOTOSOTO.toExpression(),
        ...
        "Nethack General Public License" to NGPL.toExpression(),
        ...
        "netscape public License (npl)" to NPL_1_1.toExpression(),
        "new BSD" to BSD_3_CLAUSE.toExpression(),
        "new bsd" to BSD_3_CLAUSE.toExpression(),
        "new bsd license" to BSD_3_CLAUSE.toExpression(),
        "Nokia Open Source License" to NOKIA.toExpression(),
        ...
        "Open Group Test Suite License" to OGTSL.toExpression(),
        "Open Software License 3.0" to OSL_3_0.toExpression(),
        ...
        "PostgreSQL License" to POSTGRESQL.toExpression(),
        ...
        "Ricoh Source Code Public License" to RSCPL.toExpression(),
        ...
        "Sleepycat Licence" to SLEEPYCAT.toExpression(),
        ...
        "SQLite Blessing" to BLESSING.toExpression(),
        ...
        "The BSD License" to BSD_3_CLAUSE.toExpression(),
        ...
        "University of Illinois/NCSA Open Source License" to NCSA.toExpression(),
        ...
        "https://creativecommons.org/licenses/by-nd/1.0" to CC_BY_NC_ND_1_0.toExpression(),
        "https://creativecommons.org/licenses/by-nd/2.0" to CC_BY_NC_ND_2_0.toExpression(),
        "https://creativecommons.org/licenses/by-nd/2.5" to CC_BY_NC_ND_2_5.toExpression(),
        "https://creativecommons.org/licenses/by-nd/3.0" to CC_BY_NC_ND_3_0.toExpression(),
        "https://creativecommons.org/licenses/by-nd/4.0" to CC_BY_NC_ND_4_0.toExpression(),
        "https://creativecommons.org/licenses/by-sa/1.0" to CC_BY_NC_SA_1_0.toExpression(),
        "https://creativecommons.org/licenses/by-sa/2.0" to CC_BY_NC_SA_2_0.toExpression(),
        "https://creativecommons.org/licenses/by-sa/2.5" to CC_BY_NC_SA_2_5.toExpression(),
        "https://creativecommons.org/licenses/by-sa/3.0" to CC_BY_NC_SA_3_0.toExpression(),
        "https://creativecommons.org/licenses/by-sa/4.0" to CC_BY_NC_SA_4_0.toExpression(),
        ...
        "https://opensource.org/licenses/bsd-license.php" to BSD_2_CLAUSE.toExpression(),
        ...
        "http://www.gnu.org/licenses/old-licenses/gpl-2.0.html" to GPL_2_0_ONLY.toExpression(),
        "http://www.gnu.org/licenses/old-licenses/gpl-2.0.txt" to GPL_2_0_ONLY.toExpression(),
        "https://www.gnu.org/licenses/old-licenses/lgpl-2.1.html" to LGPL_2_1_ONLY.toExpression(),
        "https://www.gnu.org/licenses/old-licenses/lgpl-2.1.txt" to LGPL_2_1_ONLY.toExpression(),
        "http://www.opensource.org/licenses/BSD-2-Clause" to BSD_2_CLAUSE.toExpression(),
        "http://www.opensource.org/licenses/BSD-3-Clause" to BSD_3_CLAUSE.toExpression(),
        "http://www.opensource.org/licenses/MIT" to MIT.toExpression(),
