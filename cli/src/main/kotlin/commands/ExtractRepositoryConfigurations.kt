...
object ExtractRepositoryConfigurations : CommandWithHelp() {
    ...
    @Parameter(description = "The input repository configuration file.",
        names = ["--repository-configuration-file", "-c"],
        required = false,
        order = PARAMETER_ORDER_OPTIONAL)
    private var inputRepositoryConfigurationFile: File? = null
    ...
    override fun runCommand(jc: JCommander): Int {
        var ortResult: OrtResult = inputOrtResultFile.readValue()
        inputRepositoryConfigurationFile?.let {
